...
- Identify relevant skills that match open positions (web development, AI, or automation).
- Access the candidate’s contact details easily.

**Needs and Expectations:**
Laura expects a **professional, structured, and easy-to-navigate** CV website. She values concise information, visual clarity, and a design that reflects technical competence and creativity. The website should load fast, and give an immediate positive impression of the candidate.
...
## Figma Design
[Figma Project Link](https://www.figma.com/site/p9wjoyGKraTAVuZrSmjQrH/CV---Marc-Espu%C3%B1a?t=TwAqAtgIlk2PaHQw-1)

---

## Live Website
[Visit the CV Website on GitHub Pages](https://yourusername.github.io/your-repo-name/) <!-- Replace this with your actual published link -->
